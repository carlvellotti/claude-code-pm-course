---
title: "CLAUDE.md for Product Managers | Project Memory Guide"
description: "Use CLAUDE.md to give Claude persistent context about your product, team, and preferences across sessions."
keywords: 'claude.md tutorial, claude.md for pms, project memory guide, claude code context, claude code memory'
---

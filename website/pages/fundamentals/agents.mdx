...
## 1.4: Agents for Parallel Work Reference
...
Imagine you have 10 meeting notes to process. Normally, youd do them one by one - thats 50 minutes of sequential work. With agents, you spin up 10 independent instances of Claude that work simultaneously. Same work, done in 5 minutes.

**Key takeaway:** Agents let you clone Claude to do multiple things at once. This isnt just faster - it unlocks entirely new workflows that would be impractical to do manually.
...
- **Without agents:** Youre one person doing tasks sequentially
- **With agents:** You can clone yourself 5, 10, or 20 times to work simultaneously

### Not Just Faster - Its Different

Heres what makes agents revolutionary:
...
Lets say youre a PM who spends time on:
...
Can tasks be done independently (no dependencies)?
    ...
    │
    └─ NO → Sequential work, dont use agents
```

### ✅ When to Use Agents

**Perfect for:**
- **Batch processing:** 10 meeting notes, 20 interviews, 15 support tickets
- **Parallel research:** 5 competitors, 3 market segments, 10 feature requests  
- **Multi-source analysis:** Different agents for interviews, surveys, tickets, social media
...
- **Quick tasks:** Simple requests that take seconds
- **Context-dependent work:** Tasks that need to build on each other

### How Many Agents?

**Many (5-20+):** Similar tasks, independent work, time-critical
**Few (2-4):** Different specializations, complex analysis needed
**One:** Single task, quick work, sequential dependencies
...
**When you tell Claude to use agents, heres what happens:**
...
- ✅ All Claudes capabilities (analysis, writing, reasoning)
- ✅ Independent context (doesnt see other agents work while running)
...
**Scenario:** Its Monday morning. You have 10 meeting recordings from last week. Your standup is in 1 hour. You need to know what happened, whats blocked, and what decisions were made.
...
- Total: 60 minutes → Youre late to standup
...
**Scenario:** Your CEO asks for competitive analysis on 5 competitors. She needs it by end of day for a board meeting. Its 2pm.
...
- Total: 5.5 hours → Youre working past midnight
...
- Gaps and opportunities (what we can do that they cant)
...
**Time saved: 4.5 hours → Attend your kids soccer game instead**

### Example 3: Multi-Source User Research

**Scenario:** Youre preparing for quarterly planning. You need to synthesize user research from 3 sources: interviews, surveys, and support tickets. Normally this takes a full day.
...
- ❌ **Dont use agents for single tasks** - Just prompt Claude directly
- ❌ **Dont create agents that need to communicate** - They work independently
- ❌ **Dont use agents for sequential work** - Tasks with dependencies should be done in order
- ❌ **Dont over-agent small tasks** - If it takes 30 seconds, dont use agents
- ❌ **Dont forget synthesis** - Raw agent outputs need combining
- ❌ **Dont use agents when context matters** - If Task 2 needs Task 1s context, do sequentially
...
### The agents arent working in parallel

**Likely cause:** The prompt wasnt explicit about parallelization
...
### Dont know if agents are still working
...
Module 1.5 introduces **custom sub-agents** - permanent team members with personalities, specializations, and visual identities (emojis and colors!). Instead of saying act like an engineer every time, youll have a 👨‍💻 Engineer sub-agent (in purple!) you can call anytime.

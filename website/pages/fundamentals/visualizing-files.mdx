...
[Nimbalyst](https://nimbalyst.com/) is a free, purpose-built wrapper for Claude Code with:
...
**Limitation:** Cannot display hidden folders like `.claude/` - you'll use Finder/Explorer for those.
...
1. **Download:** Visit https://nimbalyst.com/ and click download

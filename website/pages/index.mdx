...
[**Module 0: Getting Started**](/getting-started/introduction) – Install Claude Code, set up your environment, and have your first real conversation with AI that actually executes tasks.

[**Module 1: Fundamentals**](/fundamentals/welcome) – Master the core capabilities: file operations, visual content analysis, parallel agents, custom sub-agents, and project memory.

[**Module 2: Advanced PM Work**](/advanced/write-prd) – Apply your skills to real PM tasks: write PRDs, analyze data, and develop product strategy with AI assistance.

[**TaskFlow Context**](/company-context/overview) – Meet TaskFlow, the fictional company you'll work with throughout the course. Learn about the product, users, and competitive landscape.

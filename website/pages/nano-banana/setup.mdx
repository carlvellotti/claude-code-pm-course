...
1. Download the zip from the [Latest Release Page](https://github.com/carlvellotti/claude-code-pm-course/releases/latest)
...
Try downloading manually from the [release page](https://github.com/carlvellotti/claude-code-pm-course/releases/latest) and extracting to your Documents folder.

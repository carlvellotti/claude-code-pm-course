...
> **Start this module in Claude Code:** Run `/start-3-2-3` to begin the interactive experience.
...
Claude Code handles all the technical complexity - API calls, session management, file saving. You focus on creative direction.
...
**Stay connected:**
Check out [The Full Stack PM](https://fullstack-pm.com/subscribe?utm_source=ccforpms&utm_medium=course&utm_campaign=nano-banana-marketing) for more PM builder content, including advanced techniques and new style libraries.
...
Created by [Carl Vellotti](https://www.linkedin.com/in/carlvellotti/). Nano Banana is part of the Claude Code for Product Managers course.

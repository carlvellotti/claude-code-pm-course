...
> **Start this module in Claude Code:** Run `/start-3-1-4` to begin the interactive experience.
...
Claude looks up the style, retrieves the prompt, and applies it to your subject.
...
2. Tell Claude: "Add this style to my library"
3. Claude updates `style-library.html` with the new entry
...
3. If it works well, tell Claude to save it
...
2. Claude runs the style extraction module
...
When you tell Claude to save a style, it:
...
- **Add columns:** "Ask Claude to add a 'difficulty' column"
...
- Check that Claude confirmed the save
...
- Ask Claude: "Which styles work for [your use case]?"
...
Created by [Carl Vellotti](https://www.linkedin.com/in/carlvellotti/). Check out [The Full Stack PM](https://fullstack-pm.com/subscribe?utm_source=ccforpms&utm_medium=course&utm_campaign=nano-banana-database) for more PM builder content.

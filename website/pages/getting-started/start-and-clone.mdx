...
```bash
cd ~/Documents && curl -L https://github.com/carlvellotti/claude-code-pm-course/releases/latest/download/complete-course.zip -o course.zip && unzip course.zip -d claude-code-course && cd claude-code-course && claude
```

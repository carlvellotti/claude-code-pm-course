...
https://github.com/carlvellotti/claude-code-pm-course/releases/latest/download/complete-course.zip
and extract it to a folder called claude-code-course in my Documents folder.
```

**What Claude will do:**
1. Navigate to your Documents folder
2. Download the zip file
3. Extract it to `claude-code-course`
...
```
Tool Use: bash
Command: cd ~/Documents && curl -L https://github.com/carlvellotti/claude-code-pm-course/releases/latest/download/complete-course.zip -o course.zip && unzip course.zip -d claude-code-course
...
✓ Successfully downloaded and extracted course materials to ~/Documents/claude-code-course
...
1. Navigate to `Documents/claude-code-course`
...
### Can I download other course materials this way?

Yes. This pattern works for any downloadable files:
- GitHub release assets
- Direct download links
- Company resources

Just tell Claude the URL and where you want it extracted.

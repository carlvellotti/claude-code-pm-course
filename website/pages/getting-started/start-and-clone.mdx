...
5. Launches Claude Code and immediately starts Module 1.1
...
- **Windows:** Curl and unzip aren't built-in. Download the zip manually from the [GitHub Releases page](https://github.com/carlvellotti/claude-code-pm-course/releases/latest), extract it to your Documents folder, then open your terminal and type: `cd ~/Documents/claude-code-course && claude "/start-1-1"`

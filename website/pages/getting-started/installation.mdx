...
description: Get Claude Code installed and verified on your machine in 15 minutes
---

## 0.1 Installation Reference
...
### 3. Node.js (Well help you install if needed)
- Claude Code requires Node.js version 18 or higher
- Dont worry if you dont have it – well show you how to install it below
...
Now lets connect Claude Code to your Claude Pro or Max subscription.
...
Lets make sure everything is working properly.
...
Youre ready for Module 0.2 when you can:
...
1. ✅ Installed a powerful AI tool that most PMs dont even know exists
...
**ROI:** Infinite (youll save hours per week for the rest of your career)
...
- Dont worry about understanding every detail
- Youll learn by doing in the next modules
...
**Ready? Lets move to Module 0.2 and start using Claude Code.**

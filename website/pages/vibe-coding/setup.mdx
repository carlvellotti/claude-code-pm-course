...
> **Interactive lesson:** Run `/start-4-1` in Claude Code

**In this lesson:** Set up your project folder and learn the build loop.

## Download Course Files

If you haven't downloaded the course files yet, go back to the [Module Overview](/vibe-coding#download-the-course-materials) for download instructions. Even if you downloaded the course materials for earlier modules, you'll need to download again - this module includes new files.
...
**[4.2: Plan →](/vibe-coding/plan)** - Claude interviews you to define exactly what you're building
